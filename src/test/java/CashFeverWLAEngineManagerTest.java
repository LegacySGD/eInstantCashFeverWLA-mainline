...
public class CashFeverWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(CashFeverWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/CashFeverWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/CashFeverWLAIW/InitOutcome.xml").getDocumentElement();
